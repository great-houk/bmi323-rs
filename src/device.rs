    ...
    D: DelayNs,
{
    ...
    pub fn get_accel_range(&self) -> AccelerometerRange {
        self.accel_range
    }
    ...
    /// Gets the accelerometer range
    pub fn get_gyro_range(&self) -> GyroscopeRange {
        self.gyro_range
    }
    ...
    pub fn write_register_16bit(&mut self, reg: u8, value: u16) -> Result<(), Error<E>> {
    ...
    pub fn read_data<'a>(&mut self, data: &'a mut [u8]) -> Result<&'a [u8], Error<E>> {
